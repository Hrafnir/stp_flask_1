...
teachers = [
    ...
    },
    {
        "t_id": 1,
        "name": "Lee P",
        "about": "I am a native speaker and conversation tutor, provt_iding private English conversation lessons using something called Life Learning.This method allows students to take complete control of how and what they learn. It is student-led learning focusing on interests, life goals, enjoyment and effective learning for you, as an indivt_idual.Stop wasting time with textbooks, tests and unneccesary pressure. Find a love for learning and speaking English with creativity and freedom. The lessons are completely chosen by you to keep you motivated and driven to achieve your goals.",
        "rating": 4.8,
    ...
    },
    {
        "t_id": 2,
        "name": "Felix A",
        "about": "The English language has become the language of the world, thus, it is const_idered a world language. Today English seems to evolve to a future global tongue, as its spreading on the Internet in recent years shows (almost 80% of the worldwt_ide web's pages are now written in English). scientific researchers have found out that in fact many small languages have already vanished.But to teach it in a satisfactory manner a good teacher of English is required.xA good teacher of English must possess some qualities.Business, General and conversational English",
    ...
    },
    {
        "t_id": 4,
        "name": "Gulya S",
        "about": "Hello! My name is Gulya :) I am a native speaker of the Russian language and I am fluent in English. I have been teaching online for 3 years now. I have an indivt_idual program, having studied your requirements, I am preparing a special program. plan, and therefore deal) Books Cambrt_idge, Oxford, etc. I train and develop colloquial speech. We study words, stable combinations and put them into practice. We speak and try to speak :) on different topics. We listen to audio lessons, watch films with subtitles. We analyze everything on the shelves :) In parallel, of course, we study the basics of grammar and the correct delivery of sentences :) All the materials are provt_ided by me. I promise you that you will talk from the first first lesson :)",
    ...
    },
    {
        "t_id": 5,
        "name": "Yan M",
        "about": "Hello! My name is Yang and for more than five years I have been teaching English. I spent part of this time in China, where I worked with students from 3 to 40 years old. I deal with both adults and children. But for all ages, I try to make my classes fun and interactive. Teaching English to me is not just a language lesson. I always try to attract a wt_ider cultural and historical context that helps my students understand more about the language and its features. A degree in history helps me a lot to create such an intellectual environment in the classroom.For each student, I develop an indivt_idual curriculum that depends on its goals and needs.",
...

    {
        "t_id": 10,
        "name": "Salman S",
        "about": "I motivate and gut_ide students to achieve their goals. It depends on what is the problem they are facing. Sometimes they just want to practice speaking to improve their fluency. Sometimes it's more complicated which is a language barrier and I need to boost their conft_idence. Some are coming with a specific task to pass an exam like IELTS and TOEFL. Moreover some are seeking to improve their business skills and business conversation. Sometimes they need to pass the interview in English. According to their requirements I have materials and programs to help them to achieve their desired goals. My vast experience of teaching plays a vital role as well.",
